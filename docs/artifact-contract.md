...
This repository now documents the artifact contract, includes starter templates, and exports a machine-readable `metadata/validation-results.json` in review bundles. The contract is still only partially enforced by CLI behavior today.
